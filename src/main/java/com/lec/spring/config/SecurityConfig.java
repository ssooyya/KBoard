...
public class SecurityConfig {
    ...
    //OAuth2 Client
    @Autowired
    private PrincipalOauth2UserService princialOauth2UserService;
...
//    }
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        return http
                 ...
                 * *******************************************/
                .formLogin(form -> form
                        .loginPage("/user/login")   // 로그인 필요한 상황(인증 필요 상황)발생시, 매개변수 url (로그인 폼)으로 request 발생
